import { html_buttons } from "../interfaces/interface.js";
...
export class Streak extends daysCalulator {
    constructor() {
        ...
        this.createStreak = () => {
            ...
            const d1 = new Date();
            const d2 = new Date(html_buttons.start_date.value); // expected Completion date
    ...
    showSingleStreak(id) {
        ...
        const d2 = new Date(result.start_date_value); // expected Completion date
        var diff = Math.abs(d1 - d2);
        // console.log(diff);
